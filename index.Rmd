...
p1_age <- ggplot(data = cancer_df, aes(x = age)) +
  geom_histogram(binwidth= 7, color= "slateblue1", fill = "slateblue3") +
...
p2_nodes <- ggplot(data = cancer_df, aes(x = nodes)) +
  geom_histogram(binwidth= 3, color= "slateblue1", fill = "slateblue3") +
  theme(plot.title = element_text(size = 15), axis.title = element_text(size = 16), axis.text = element_text(size = 16)) +
  labs(x = "Nodes",
       y = "Count",
...
p3_pgr <- ggplot(data = cancer_df, aes(x = pgr)) +
  geom_histogram(binwidth= 420, color= "slateblue1", fill = "slateblue3") +
  theme(plot.title = element_text(size = 15), axis.title = element_text(size = 16), axis.text = element_text(size = 16)) +
  labs(x = "pgr",
       y = "Count",
...
p4_er <- ggplot(data = cancer_df, aes(x = er)) +
  geom_histogram(binwidth= 300, color= "slateblue1", fill = "slateblue3") +
  theme(plot.title = element_text(size = 15), axis.title = element_text(size = 16), axis.text = element_text(size = 16)) +
  labs(x = "er",
       y = "Count",
...
p5_size <- ggplot(data = cancer_df, aes(x = size)) +
  geom_bar(width = 0.7, color= "slateblue1", fill = "slateblue3") +
  geom_text(data = . %>% 
              group_by(size) %>% 
              tally() %>% 
...
p7_meno <- ggplot(data = cancer_df, aes(x = factor(meno), color = factor(meno), fill = factor(meno))) +
  ...
  scale_color_manual(values = c("slateblue1", "goldenrod2")) +
  geom_text(data = . %>% 
              group_by(meno) %>% 
              tally() %>% 
              mutate(prop = round(n/sum(n),3)) %>% 
