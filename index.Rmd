...
Cox regression is used for modelling time-to-event data to relate the outcome (survival duration or `dtime`) to one or more covariates. It estimates **hazard ratios** which describe, in this analysis, the relative probability of `death` occuring at `dtime`, given that `death` hasn't happened up until time `dtime`.  
