...
p1_age <- ggplot(data = cancer_df, aes(x = age)) +
  geom_histogram(binwidth= 7, color= "#ce90b4", fill = "#ae4683") +
...
p2_nodes <- ggplot(data = cancer_df, aes(x = nodes)) +
  geom_histogram(binwidth= 3, color= "#ce90b4", fill = "#ae4683") +
  theme(plot.title = element_text(size = 16), axis.title = element_text(size = 16), axis.text = element_text(size = 16)) +
  labs(x = "Nodes",
       y = "Count",
...
p3_pgr <- ggplot(data = cancer_df, aes(x = pgr)) +
  geom_histogram(binwidth= 420, color= "#ce90b4", fill = "#ae4683") +
  theme(plot.title = element_text(size = 16), axis.title = element_text(size = 16), axis.text = element_text(size = 16)) +
  labs(x = "pgr",
       y = "Count",
...
p4_er <- ggplot(data = cancer_df, aes(x = er)) +
  geom_histogram(binwidth= 300, color= "#ce90b4", fill = "#ae4683") +
  theme(plot.title = element_text(size = 16), axis.title = element_text(size = 16), axis.text = element_text(size = 16)) +
  labs(x = "er",
       y = "Count",
...
p5_size <- ggplot(data = cancer_df, aes(x = size)) +
  geom_bar(width = 0.7, color= "#ce90b4", fill = "#ae4683") +
  geom_text(data = . %>% 
              group_by(size) %>% 
              tally() %>% 
...
p7_meno <- ggplot(data = cancer_df, aes(x = factor(meno), color = factor(meno), fill = factor(meno))) +
  ...
  scale_fill_manual(values = c("#ae4683", "peru")) +
...
hist_01 <- ggplot(cancer_df, aes(dtime)) +
  ...
  scale_fill_manual(values = c("#ae4683", "peru"), labels = c("0 - Alive/Censored", "1 - Dead")) +
